...
def plot_gamma2_behavior():
    ...
    x_errors = np.linspace(0, 200, 500)
    ...
    plt.xlabel("Squared Distance Error ($d^2$)", fontsize=22)
    plt.ylabel("Gamma2 Value", fontsize=22)
    plt.legend(fontsize=20)
    plt.tick_params(labelsize=16)
    plt.grid(True, alpha=0.3)

    # Y軸の範囲を少し広めに
    plt.ylim(gamma2_min - 0.0001, gamma2_max + 0.001)
